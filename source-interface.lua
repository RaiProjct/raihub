...
function Hide()
	Debounce = true
	PrivilegedLibrary:Notify({Title = "Interface oculta", Content = "A interface foi ocultada, você pode reexibi-la tocando em K", Duration = 7})
...
function PrivilegedLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by swe7z"
